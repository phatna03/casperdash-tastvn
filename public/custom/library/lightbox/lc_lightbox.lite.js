...
(function ($) {
  ...
  var lcl = function (obj, settings) {
    ...
    var lcl_settings = $.extend({
      ...
      slideshow: false, // whether to enable slideshow
      ...
      radius: 1, // lightbox border radius in pixels
      shadow: true, // whether to apply a shadow around lightbox window
      remove_scrollbar: true, // whether to hide page's vertical scroller

      wrap_class: '', // custom classes added to wrapper - for custom styling/tracking
      skin: 'minimal', // light / dark / custom
      //custome
      data_position: 'rside', // over / under / lside / rside
      cmd_position: 'outer', // inner / outer
      ...
      thumbs_nav: false, // enables thumbnails navigation (requires elements poster or images)
      ...
      txt_toggle_cmd: false, // bool / allow text hiding
    ...
    var populate_lb = function (el) {
      ...
      if (elem_has_txt(el) && el.type != 'unknown') {
        ...
        //custome
        // if (el.title) {
        var acm_infos = el.title.split('at');
        var acm_html = '<div>' + acm_infos[0] + '</div>'
          + '<div class="acm-mt-px-10 acm-mb-px-10">ID: ' + el.author + '</div>'
          + '<div class="acm-text-right acm-fs-13 mt-2">' + acm_infos[1] + '</div>';

        $('#lcl_txt').append('<h3 id="lcl_title">' + acm_html + '</h3>');
        // }
        ...
        //custome
        var acm_note = '<div class="form-floating form-floating-outline"><textarea class="form-control h-px-300 acm-text-black" name="note">' + el.txt + '</textarea><label class="acm-lbl-highlight">Note</label></div>';
        ...
        var acm_html = '<div class="mt-4">' + acm_note + '</div>'
          + '<div class="mt-2">' + acm_button + '</div>'
          + '<div class="mt-2"><input type="hidden" name="object_id" value="' + acm_obj_id + '" /></div>'
        ;
