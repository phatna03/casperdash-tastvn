  ...
  var lcl = function (obj, settings) {
    ...
    var populate_lb = function (el) {
      ...
      if (elem_has_txt(el) && el.type != 'unknown') {
        ...
        var acm_hidden_2 = '<input type="text" name="food_count" class="form-control text-center text-dark fw-bold fnumber" placeholder="Number of dishes" onblur="input_number_min_two(this);" autocomplete="off" />';
