...
@endphp
<div class="wrap_text_roboflow_ingredient @if($viewer->is_dev() || $viewer->is_admin()) cursor-pointer @endif @if($ingredient->ingredient_type == 'core') cored text-danger @else text-dark @endif"
