  ...
  <div class="card mb-4">
    <form class="card-body" onsubmit="return user_profile_confirm(event, this);" id="frm-profile">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-3">
          <div class="form-floating form-floating-outline">
            <input type="text" name="info_ips_printer" id="info-ips_printer" class="form-control text-center"
                   value="{{$viewer->ips_printer}}"
            />
            <label for="info-phone">Printer IPs</label>
            <div class="form-text">Separated by semicolon (;)</div>
          </div>
        </div>
        <div class="col-md-12 acm-text-right">
          <button type="button" class="btn btn-secondary me-sm-3 me-1" onclick="user_test_printer()">Test Printer</button>
  ...
  <div class="card mb-4">
    <form class="card-body" onsubmit="return user_pwd_confirm(event, this);" id="frm-pwd">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-3">
          <div class="form-floating form-floating-outline">
            <input type="password" name="pwd_pwd1" id="pwd-pwd1" class="form-control text-center" autocomplete="new-password"
                   required
            />
        ...
        <div class="col-md-3">
          <div class="form-floating form-floating-outline">
            <input type="password" name="pwd_pwd2" id="pwd-pwd2" class="form-control text-center" autocomplete="new-password"
                   required
            />
        ...
        <div class="col-md-3 acm-text-right">
          <button type="button" class="btn btn-secondary me-sm-3 me-1" onclick="user_code_confirm()">Send Verify Code</button>
          <button type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
        </div>
      </div>
    </form>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="user_profile()" class="btn btn-primary" data-bs-dismiss="modal">Confirm</button>
