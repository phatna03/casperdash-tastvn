...
@section('content')
  ...
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Restaurant: {{$pageConfigs['item']->name}}</h4>
      ...
      <div class="card h-100">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn btn-primary p-1" type="button"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="mdi mdi-filter mdi-18px"></i>
              </button>
              <div class="dropdown-menu dropdown-menu-end">
                <div class="w-px-400 p-2">
                  <div class="form-floating form-floating-outline">
                    <input type="text" class="form-control text-center date_time_picker" name="search_time" autocomplete="off"
        ...
        <div class="card-body d-flex justify-content-between flex-wrap gap-3">
          <div class="d-flex gap-3">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu stats-food-category-list"></ul>
            </div>
          ...
          <div class="d-flex gap-3">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu stats-food-list"></ul>
            </div>
            <div class="card-info">
              <div>
          ...
          <div class="d-flex gap-3">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu stats-ingredients-missing-list"></ul>
            </div>
            <div class="card-info">
              <div>
          ...
          <div class="d-flex gap-3">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu stats-time-frames-list"></ul>
            </div>
            <div class="card-info">
              <div>
          ...
          <ul class="nav nav-tabs nav-fill" role="tablist">
            <li class="nav-item">
              <button type="button" class="nav-link active" role="tab"
                      data-bs-toggle="tab" data-bs-target="#datatable-listing-scan" aria-controls="datatable-listing-scan" aria-selected="true">
            ...
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab"
                      data-bs-toggle="tab" data-bs-target="#datatable-listing-error" aria-controls="datatable-listing-error" aria-selected="false">
                <i class="tf-icons mdi mdi-view-list me-1"></i> List of errors
              </button>
            </li>
            <li class="nav-item">
              <button type="button" class="nav-link " role="tab"
                      data-bs-toggle="tab" data-bs-target="#datatable-listing-food" aria-controls="datatable-listing-food" aria-selected="false">
                    ...
                    <div class="col-md-6 mb-2">
                      <div class="form-floating form-floating-outline wrap-select-food-category">
                        <div class="form-control acm-wrap-selectize" id="scan-search-food-category">
                          <select name="categories" multiple onchange="restaurant_search_food_scan(this)"></select>
                        </div>
                    ...
                    <div class="col-md-6 mb-2">
                      <div class="form-floating form-floating-outline wrap-select-food">
                        <div class="form-control acm-wrap-selectize" id="scan-search-food">
                          <select name="foods" multiple onchange="restaurant_search_food_scan(this)"></select>
                        </div>
                    ...
                    <div class="col-md-6 mb-2">
                      <div class="form-floating form-floating-outline wrap-select-food-category">
                        <div class="form-control acm-wrap-selectize" id="error-search-food-category">
                          <select name="categories" multiple onchange="restaurant_search_food_scan_error(this)"></select>
                        </div>
                    ...
                    <div class="col-md-6 mb-2">
                      <div class="form-floating form-floating-outline wrap-select-food">
                        <div class="form-control acm-wrap-selectize" id="error-search-food">
                          <select name="foods" multiple onchange="restaurant_search_food_scan_error(this)"></select>
                        </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas_add_foods" aria-labelledby="offcanvas_add_foods_label">
  ...
  <div class="modal animate__animated animate__rollIn" id="modal_delete_food_out_restaurant" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="restaurant_delete_food(this)" class="btn btn-primary" data-bs-dismiss="modal">Confirm</button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col mb-12 mt-2">
              <div class="alert alert-danger">Are you sure you want to re-training Roboflow with current search results?</div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" onclick="roboflow_retraining()" class="btn btn-primary" data-bs-dismiss="modal">Confirm</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal animate__animated animate__rollIn" id="modal_delete_food_scan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" onclick="restaurant_delete_food_scan(this)" class="btn btn-primary" data-bs-dismiss="modal">Confirm</button>
  ...
  <script type="text/javascript">
    ...
    var datatable_listing_scan_cfs = {
      ...
      "createdRow": function( row, data, dataIndex ) {
        ...
        // $(row).attr('onclick', 'restaurant_food_scan_result_info(' + data.id + ')');
      ...
      buttons: [
          {{--{--}}
          {{--  extend: 'collection',--}}
          {{--  text: '<i class="mdi mdi-scanner me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Get Scan Results</span>',--}}
          {{--  className: 'add-new btn btn-primary waves-effect waves-light acm-mr-px-10',--}}
          {{--  --}}{{--attr: {--}}
          {{--  --}}{{--  'onclick': 'restaurant_get_scan_results({{$pageConfigs['item']->id}})',--}}
          {{--  --}}{{--},--}}
          {{--  buttons: [--}}
          {{--    {--}}
          {{--      text: '<input type="text" class="form-control text-center" name="get_date" placeholder="YYYY-mm-dd" />',--}}
          {{--      className: 'dropdown-item',--}}
          {{--    },--}}
          {{--    {--}}
          {{--      text: '<input type="text" class="form-control text-center fnumber" name="get_hour" placeholder="giờ..." />',--}}
          {{--      className: 'dropdown-item',--}}
          {{--    },--}}
          {{--    {--}}
          {{--      text: '<div class="text-center wrap-btn bg-primary text-white p-1"><i class="mdi mdi-scanner me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Submit</span></div>',--}}
          {{--      className: 'dropdown-item',--}}
          {{--      attr: {--}}
          {{--        'onclick': 'restaurant_get_scan_results(this, {{$pageConfigs['item']->id}})',--}}
          {{--      },--}}
          {{--    },--}}
          {{--  ],--}}
          {{--},--}}
