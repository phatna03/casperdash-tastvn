  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-users table" id="tbl_dashboard">
        ...
        <tr>
          ...
          <th class="text-center">Latest updated</th>
          <th></th>
        </tr>
        </thead>
        <tbody>
        @for($i=1;$i<=15;$i++)
          <tr>
            ...
            <td>
              <span>
                <button type="button" class="btn btn-sm btn-icon btn-primary" title="View restaurant"
                  onclick="parent.window.location.href='{{url('admin/restaurant/info')}}'"
                >
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
      <div class="offcanvas-header">
        <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Add Restaurant</h5>
...
{{--                  type="submit"--}}
    ...
    <!-- Offcanvas to edit Restaurant -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditUser" aria-labelledby="offcanvasEditUserLabel">
      <div class="offcanvas-header">
        <h5 id="offcanvasEditUserLabel" class="offcanvas-title">Edit Restaurant</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body mx-0 flex-grow-0 h-100">
