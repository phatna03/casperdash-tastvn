        ...
        <div class="card p-2">
          ...
          <div class="app-brand justify-content-center mt-5 mb-4">
            <a href="{{url('/')}}" class="app-brand-link gap-2">
              ...
              <span class="app-brand-text demo text-heading fw-bold">{{config('tastvn.templateName')}}</span>
            </a>
          </div>
          <!-- /Logo -->
          <!-- Reset Password -->
              ...
              <div class="mb-3 form-password-toggle">
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    <input type="password" id="password" class="form-control" name="code" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                    <label for="password">Code</label>
                  </div>
                  <span class="input-group-text cursor-pointer"><i class="mdi mdi-code-array"></i></span>
                </div>
              </div>
              <div class="mb-3 form-password-toggle">
                <div class="input-group input-group-merge">
